...
var Carousel = function (_Component) {
    ...
    function Carousel(props) {
        ...
        _this.onSwiping = function (e, deltaX, deltaY, absX, absY, velocity) {
            var isHorizontal = _this.props.axis === "horizontal";
            ...
            var axisDelta = isHorizontal ? deltaX * -1 : deltaY * -1;
    ...
    _createClass(Carousel, [{
        ...
        value: function render() {
            ...
            if (isHorizontal) {
                ...
                swiperProps.onSwipingUp = this.props.verticalSwipe === "natural" ? this.increment : this.decrement;
                swiperProps.onSwipingDown = this.props.verticalSwipe === "natural" ? this.decrement : this.increment;
                        ...
                        this.props.swipeable ? _react2.default.createElement(
                            "div",
                            {
                                onTouchStart: function onTouchStart() {
                                    return _this4.onTouchStart();
                                },
                                onTouchEnd: function onTouchEnd() {
                                    return _this4.onTouchEnd();
                                }
                            },
                            _react2.default.createElement(
